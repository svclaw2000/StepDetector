...
public class MLPTest extends AppCompatActivity {
	TextView Tversion;
	TextView Tlog;
	ScrollView Slog;
	Button Bswitch;
		...
		public void onSensorChanged(SensorEvent event) {
			...
			if (acceReady && gyroReady) {
				...
				if (++count == WindowSize) {
					...
					Log.i("@@@", data);
					try {
						httpTask = new HttpAsyncTask(MLPTest.this);
	...
	String POST(String rawdata) {
		String url = "http://svclaw.ipdisk.co.kr:8002/shopCharacter/getmlpresult/";
