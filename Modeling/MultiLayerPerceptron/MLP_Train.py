...
mlp = MLPClassifier(solver='sgd', activation='relu', alpha=1e-5, random_state=123456,
					max_iter=200, verbose=0, learning_rate_init=.1)
hidden_layer_sizes_range = [(x,y,z) for x in range(10,200,10) for y in range(10,200,10) for z in range(10, 200, 10)]
